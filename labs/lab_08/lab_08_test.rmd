...
county_url <- 'https://raw.githubusercontent.com/smussenden/spring20-data-journalism/master/labs/lab_05/data/county_pills_per_year.csv'

```

```{r}
county_downloaded <- read_csv(county_url)
...
```{r}
state_population_white_only <- get_acs(geography = "state", 
