...
# The data has 290,908 rows and 42 columns 
# Buyer zip is set as a dbl but we would never do any math with a zip code
#Reporter DEA NO is set as a chr but should be a dbl
# Missing numbers are set null
...
#	3423-3425 SINCLAIR LANE had the most pills sent to it
 
#The DEA charged this pharmacy for illegally selling 10 million hyrdrocodone pills over the internet and laundeing 20 million in proceeds and failing to pay taxes. The state of Maryland shut the pharmacy down.  

# The DEA and state of Maryland charged Newcare Home Health Services located in the 3400 block of Sinclair Lane in Baltimore City. The pharmacy received 6,133,600 between 2006 and 2012. The DEA brought federal charges against the pharmacy and Maryland shut them down.    
...
# The name of the distrabutor is MCKESSON CORPORATION in Maryland and they sent 49,834,830	
...
```{r}
baltimore %>%
  group_by(buyer_state, buyer_address1) %>%
  filter(reporter_name== "MCKESSON CORPORATION")%>%
  summarise(shipments = n()) %>%
  arrange(desc(shipments))

# MCKESSON CORPORATION sent Sinai Hospital 6254 shipments. This pharmacy is a hospital which is unique from other pharmacies. 
...
#Rite Aid of Maryland, Inc. recieved 12.52 percent of total pills between 2006 and 2012.
...
```{r}
# The entity is Rite Aid of Maryland, Inc. recieved 12.52 percent of total pills between 2006 and 2012. the total number of pills was 133721503	
