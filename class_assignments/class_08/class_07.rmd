...
```{r}
geo_pills_population_county_wv <- county_geodata_shifted %>%
...
geo_pills_population_county_wv %>%
   ...
   geom_sf(lwd = 0) +
   theme_map() +
   labs(fill='Pills per Person',title="Starting slow, pill shipments rapidly increase between 2006 and 2012 ", subtitle = "Pills per person shipped to West Virginia counties, 2006 to 2014", caption = "Source: ARCOS database") +
...
geo_pills_population_county_wv %>%
   ...
   geom_sf(lwd = 0) +
   theme_map() +
   labs(fill='Pills per Person',title="Starting slow, pill shipments rapidly increase between 2006 and 2012 ", subtitle = "Pills per person shipped to Maryland counties, 2006 to 2012", caption = "Source: ARCOS database") +
   theme(legend.position="bottom") +
   scale_fill_viridis_c(option = "magma")
...
```{r}
# Pill shipments were high between 2007 and 2010. 
...
```{r}
geo_pills_population_county_wv_ky <- county_geodata_shifted %>%
   inner_join(pills_population_county_wv, by=c("GEOID" = "countyfips"))
```
...
geo_pills_population_county_wv_ky %>%
   ...
   geom_sf(lwd = 0) +
   theme_map() +
   labs(fill='Pills per Person',title="Starting slow, pill shipments rapidly increase between 2006 and 2009 ", subtitle = "Pills per person shipped to WV and Ky counties, 2006 to 2009", caption = "Source: ARCOS database") +
   theme(legend.position="bottom") +
   scale_fill_viridis_c(option = "magma")
```
