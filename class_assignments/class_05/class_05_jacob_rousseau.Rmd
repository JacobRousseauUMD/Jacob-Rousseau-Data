...
```{r}
# The number of records is higher for annual by year because it is giving us records for every buyer for every year, while the buyer total is giving us the total record over all of the years combined. 

# The buyer addresses are higher than the buyer totals because there could be several pharmacies buying under the same name but under different addresses. For example, rite aid could have three pharmacies in the same county but at different addresses.
...
# VA Consolidated Mail Outpatient Pharmacy, location is north charleston SC 
